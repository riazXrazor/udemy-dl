...
udemy-dl/2.0.3 win32-x64 node-v10.16.3
$ udl --help [COMMAND]
USAGE
  $ udl COMMAND
...
...
_See code: [src\commands\login.js](https://github.com/riazXrazor/udemy-dl/blob/v2.0.3/src\commands\login.js)_
...
_See code: [src\commands\reset.js](https://github.com/riazXrazor/udemy-dl/blob/v2.0.3/src\commands\reset.js)_
